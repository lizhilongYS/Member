...
<script type="text/javascript"
	src='${pageContext.request.contextPath}/jslib/SG_area_select.js'></script>
<script type="text/javascript"
	src='${pageContext.request.contextPath}/jslib/iscroll.js'></script>
<link
	...
	function getSchool(page2,province){
		$.post("${pageContext.request.contextPath}/member/getSchoolByPage.action",{"province":province,"page2":page2},function(data){
			...
			if(list!=null&&list.length>0){
				...
				$("#schools").html("<h4 align='center'>该省暂无会员</h4>");
			}
		});
	}
	//分页按钮点击事件
