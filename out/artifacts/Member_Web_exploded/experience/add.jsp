			...
			<div class="panel-body">
				<form name="add">
					<table class="table table-hover">
						<tr>
							<th>用户名</th>
							<td><input name="num" type="text" placeholder="必填项" readonly
								style="width: 200px" class="form-control" required /></td>
						</tr>
						<tr>
							<th>密码</th>
							<td><input name="password" type="hidden"
								class="form-control" value="12345678" /> 初始密码为：12345678</td>
						</tr>
						<tr>
							<th>性别</th>
						...
						<tr>
							<th>所在学校</th>
							<td><input name="school" type="text" placeholder="必填项"
								style="width: 200px" class="form-control" required /></td>
						</tr>
						<tr>
							<th>工作单位</th>
							<td><input name="company" type="text" placeholder="非必填项"
								style="width: 200px" class="form-control" /></td>
						</tr>
						<tr>
							<th>联系电话</th>
							<td><input name="phone" type="text" placeholder="必填项"
								style="width: 200px" class="form-control" required /></td>
						</tr>
						<tr>
							<th>QQ号码</th>
							<td><input name="qq" type="text" placeholder="必填项"
								style="width: 200px" class="form-control" required /></td>
						</tr>
						<tr>
							<th>所在省份</th>
						...
						<tr>
							<th>出生地</th>
							<td><select name="seat_province" class="form-control"
								style="width: 200px"></select></td>
						</tr>
						<tr>
							<th>是否毕业</th>
						...
						<tr>
							<th>毕业时间</th>
							<td><input type="date" name="graduateDate"
								value="2000-07-15" placeholder="必填项" class="form-control"
