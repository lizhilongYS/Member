		...
		for(i=0;i<data.length;i++){			
			$.post("${pageContext.request.contextPath}/course/getLessons.action",{chid:data[i].id},function(data2){	
				...
				for(j=0;j<data2.length;j++){
					...
					line=line+"<p ><a  style='text-decoration:none' title='课程章节' target='_blank'>"+data2[j].title+ img +"</a></p>";	
					}
				line=line+"</div>";
				line = line + "</li>";				
			});			
...
.operate ul li a {
	background: url(../images/bg1.png) no-repeat 270px 18px;
	padding-left: 30px;
...
.operate ul li h4 {
	cursor: pointer;
	background: url(../images/bg3.png) no-repeat 90% 18px;
	padding-left: 30px;
	text-decoration: none;
	font-size: 16px;
	color: #555;
...
<body>
	...
	<div class="pd-20">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l" style="font-size: 20px"> </span> <span class="r">已完成：<strong
				id="proportion"></strong> %
			</span>
		</div>
	</div>
	<div style="margin-left: 20px; font-size: 16px; color: green">
		双击&nbsp;&nbsp;&nbsp;<img
			src='${pageContext.request.contextPath}/images/ok-green.png'>&nbsp;&nbsp;&nbsp;<img
			src='${pageContext.request.contextPath}/images/x-red.png'>&nbsp;&nbsp;&nbsp;图标选择当前学习进度，选修课可跳过选择；只有可选的专业才能设置进度
	</div>
	<div>
