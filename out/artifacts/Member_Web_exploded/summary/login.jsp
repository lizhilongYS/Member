...
<link href="${pageContext.request.contextPath}/css/layer-login.css"
	rel="stylesheet">
...
<body>
	<div id="login">
		<form action="" method="post" class="form-signin" role="form">
			<input type="hidden" value="${ param.contents }" id="contents" /> <input
				type="hidden" value="${ param.state }" id="state" /> <input
				type="hidden" value="${ param.id }" id="id" />
			<div id="att" style="color: red; font-size: 18px">亲，登录过后周报就会保存啦！</div>
			<input type="text" name="name" class="form-control"
				placeholder="用会员编号登录" required autofocus style="margin-top: 40px" />
