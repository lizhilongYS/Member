...
<body>
	<div class="panel panel-secondary">
		<div class="panel-header">
			...
			</span> <span id="time"></span> 工作日志 <span class="btn btn-primary radius"
				id="write">编写工作日志</span>
			<div style="float: right">
				时间选择： <input class="input-text radius" id="date" type="text"
