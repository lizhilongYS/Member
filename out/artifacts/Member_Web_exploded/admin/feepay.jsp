<%@ page autoFlush="true" buffer="1094kb" language="java"
	...
	<div class="panel panel-secondary">
		<div class="panel-header cl">
			<div class="btn-group f-l">
				...
				<span class="btn btn-primary radius choices" lang="1">延期信息</span> <span
					class="btn btn-primary radius choices" lang="2">异常信息</span>
			</div>
			<div class="btn-group f-r">
				<a id="download" class="btn btn-success radius">生成表格</a> <a id="dl"
					class="btn btn-success radius">点击下载</a>
			</div>
		</div>
