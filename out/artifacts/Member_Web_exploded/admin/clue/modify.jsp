...
<script type="text/javascript">
	$(function() {
		...
		/*获取助教信息*/
		$.post("${pageContext.request.contextPath}/admin/getWorkAdmin.action", {}, function(data) {
			var len = data.length;
			var admin;
			...
			for(i=0;i<len;i++){
				admin = data[i];
				if(admin.id == aid) {
					options += "<option value='"+admin.id+"' selected = 'selected'>"+admin.realname+"</option>";
				}else{
					options += "<option value='"+admin.id+"' >"+admin.realname+"</option>";
				}
			}
			 $(".assistants").html(options);
		});
			...
			<div class="panel-primary">
				<form id="modify">
					...
					<table class="table table-border table-hover radius">
						<tr>
							<th>用户名</th>
							<td><input name="num" type="text" readonly
								style="width: 200px" class="input-text radius" /></td>
						</tr>

						<tr>
							<th>QQ号码</th>
							<td><input name="qq" type="text" readonly
								style="width: 200px" class="input-text radius" /></td>
						</tr>

						<tr>
							<th>性别</th>
							<td><input type="radio" name="sex" value="男" checked><label>男</label>
								<input type="radio" name="sex" value="女"
								style="margin-left: 20px"><label>女</label> <input
								type="radio" name="sex" value="不详" style="margin-left: 20px"><label>不详</label>
							</td>
						</tr>

						<tr>
							<th>开始时间</th>
							<td><input type="text" name="bdate" style="width: 200px"
								class="input-text radius" /></td>
						</tr>

						<tr>
							<th>真实姓名</th>
							<td><input name="realName" type="text" style="width: 200px"
								class="input-text radius" /></td>
						</tr>
						...
						<tr>
							<th>学历</th>
							<td><input name="diploma" type="text" style="width: 200px"
								class="input-text radius" /></td>
						</tr>

						<tr>
							<th>手机号</th>
							<td><input name="phone" type="text" style="width: 200px"
								class="input-text radius" /></td>
						</tr>

						<tr>
							<th>毕业时间</th>
							<td><input type="text" name="gdate" style="width: 200px"
								class="input-text radius" /></td>
						</tr>

						<tr>
							<th>是否学生</th>
							<td><input type="radio" name="type" value="1" checked><label>是</label>
								<input type="radio" name="type" value="0"
								style="margin-left: 20px"><label>否</label></td>
						</tr>
						<tr>
							<th>选择助教</th>
							<td><select class="select-box radius assistants"
