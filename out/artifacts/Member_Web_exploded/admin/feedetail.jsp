...
<body>
	...
	<div id="title" style="padding-left: 250px">
		姓名：<span id="name"></span>&nbsp;&nbsp; 类型：<span id="studentType"></span>
		<br />
		<table id="accountlog" class="table table-bordered">
		</table>
		<br /> 注册日期:<span id="registerTime"></span>&nbsp;&nbsp; 未交本金合计：<span
			id="restAmount"></span>&nbsp;&nbsp; <input type='button' id='mid'
			value='缴费纠错' onclick=recovery() lang='' class='btn btn-danger'>
		<br /> <br />
	</div>
