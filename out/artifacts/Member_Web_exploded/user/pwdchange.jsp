...
--%>
	...
	<form method="post" name="f1"
		action="${pageContext.request.contextPath}/user/changePassword.action">
		<input type="hidden" name="name" value="${myuser.name}"> <input
			type="hidden" name="id" value="${myuser.id}">
