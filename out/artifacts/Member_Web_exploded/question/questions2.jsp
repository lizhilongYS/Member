	...
	<div class="top">
		...
		<div id="ad_setting" class="ad_setting">
			...
			<ul class="dropdown-menu-uu" style="display: none" id="ad_setting_ul">
				<li class="ad_setting_ul_li" onclick="personal()"><a
					href="javascript:;"><i class="icon-user glyph-icon"></i>个人中心</a></li>
				<li class="ad_setting_ul_li" onclick="exit()"><a
					href="javascript:;"><i class="icon-signout glyph-icon"></i> <span
	...
	<div class="left-menu">
		<ul id="menu">
			<li class="menu-list"><a style="cursor: pointer"
				href="javascript:;" title="主页"><i></i></i><i class="Hui-iconfont">&#xe625;</i>主页</a>
			</li>
			...
			<c:if test="${!myuser.member.flag}">
				<li class="menu-list"><a style="cursor: pointer"><i></i><i></i>费用信息</a>
					...
					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;" title="缴费"
							onclick="noRoot()"><i></i><i></i><i></i>缴费</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
