...
<body>
	...
	<div class="panel panel-secondary">
		<div class="panel-header">
			<div class="btn-group">
				<a
					href="${pageContext.request.contextPath}/thanksgiving/restinfo.jsp"
					class="btn btn-primary radius" target="_blank">利息明细</aa> <a
					href="${pageContext.request.contextPath}/thanksgiving/payinfo.jsp"
					class="btn btn-primary radius" target="_blank">交易明细</a>
			</div>
		</div>
