...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/mywrite.css" />
<script type="text/javascript"
	src="https://cdn.bootcss.com/jquery/3.3.1/jquery.min.js"></script>


<style type="text/css">
#chartdiv_01, #chartdiv_02, #chartdiv_03 {
	display: inline;
}
...
<body>
	...
	<div class="content-wrap" style="padding-left: 300px">
		...
		<div class="mywridiv" style="width: 800px;">
			<span class="mywridivspan">会员的周报</span> <span class="mywridivspan2"
				id="prevweek">向前一周</span> <span class="mywridivspan3"
				id="currentweek">回到本周</span> <span class="mywridivspan4"
				id="nextweek">向后一周</span>
		</div>
		...
		<div class="paging" style="width: 800px;">
			<div class="paingdivinner">
				<span id="back"> <c:if test="${myuser.member!=null}">
					...
					href="${pageContext.request.contextPath}/ueditor/memberlooksum.jsp?pages=1">首页</a>&nbsp;&nbsp;
				<c:choose>
					...
					<c:when test="${param.pages>1}">
						<a
							href="${pageContext.request.contextPath}/ueditor/memberlooksum.jsp?pages=${param.pages-1}">上一页</a>&nbsp;&nbsp;	
	</c:when>
				</c:choose>
				<c:choose>
					...
					<c:when test="${param.pages<AllPageCounts}">
						<a
							href="${pageContext.request.contextPath}/ueditor/memberlooksum.jsp?pages=${param.pages+1}">下一页</a>&nbsp;&nbsp;
	</c:when>
				</c:choose>
				<a
					href="${pageContext.request.contextPath}/ueditor/memberlooksum.jsp?pages=${AllPageCounts}">尾页</a>&nbsp;&nbsp;
				<span>第<span id="currentPageNum"> <c:if
							test="${param.pages!=null}">${param.pages}</c:if> <c:if
							test="${param.pages==null}">1</c:if>
				</span>页
				</span> &nbsp;/&nbsp; <span>共<span id="pageSum">${AllPageCounts}</span>页
				</span>
			</div>
		</div>
	</div>
