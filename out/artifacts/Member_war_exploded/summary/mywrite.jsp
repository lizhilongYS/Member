	...
	<div class="content-wrap" style="padding-left: 300px;">
		...
		<div class="paging" style="width: 800px;">
			<div class="paingdivinner">
				<span id="back"> <a
					href="${pageContext.request.contextPath}/ueditor/memberlooksum.jsp">会员周报</a>&nbsp;&nbsp;
					<a href="${pageContext.request.contextPath}/member/infoshow.jsp">返回主页</a>
				</span> <a
					href="${pageContext.request.contextPath}/ueditor/mywrite.jsp?page=1">首页</a>&nbsp;&nbsp;
				<c:choose>
					...
					<c:when test="${param.page>1}">
						<a
							href="${pageContext.request.contextPath}/ueditor/mywrite.jsp?page=${param.page-1}">上一页</a>&nbsp;&nbsp;	
	</c:when>
				</c:choose>
				<c:choose>
					...
					<c:when test="${param.page<pageCount}">
						<a
							href="${pageContext.request.contextPath}/ueditor/mywrite.jsp?page=${param.page+1}">下一页</a>&nbsp;&nbsp;
	</c:when>
				</c:choose>
				<a
					href="${pageContext.request.contextPath}/ueditor/mywrite.jsp?page=${pageCount}">尾页</a>&nbsp;&nbsp;
