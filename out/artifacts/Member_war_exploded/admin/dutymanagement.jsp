...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/tableTemplet/lib/jquery/1.9.1/jquery.min.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/tableTemplet/lib/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/tableTemplet/lib/datatables/1.10.0/jquery.dataTables.min.js"></script>
<script type="text/javascript">
...
<body>
	...
	<div class="pd-20">
		<div class="text-c">
			选择查看日期： <input type="text" name="date1" id="logmin"
				class="span2 input-text Wdate"
				onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'logmax\')||\'%y-%M-%d\'}'})"
				style="width: 120px;"> - <input type="text" name="date2"
				id="logmax" class="span2 input-text Wdate"
				onfocus="WdatePicker({minDate:'#F{$dp.$D(\'logmin\')}',maxDate:'%y-%M-%d'})"
				style="width: 120px;"> 值班信息： <span class="select-box inline">
				<select class="select" name="type">
					<option value="0">未审核</option>
					<option value="1">全部</option>
			</select>
			</span>
			<button id="query" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i>查询
			</button>
			<button id="set" class="btn" type="submit">添加值班</button>
			<br> <br> 输入会员姓名： <input type="text"
				class="span2 input-text" id="name2" style="width: 120px;"> <span
				id="append2" class="select-box inline" style="display: none;"></span>
			<button id="get" class="btn" type="submit">查找</button>
		</div>
	</div>
	<div style="display: none; text-align: center" id="hha">
		选择值班时间： <input type="text" class="span2 input-text Wdate"
			name="startdate" id="startdate" readonly="readonly"
			onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" style="width: 120px;">
		<input type="text" class="span1 span2 input-text Wdate" readonly
			name="starttime" id="starttime"
			onfocus="WdatePicker({dateFmt:'H:mm',minDate:'8:30',maxDate:'21:30',onpicked:function(){endtime.focus()} })"
			style="width: 120px;"> ~ <input type="text"
			class="span1 span2 input-text Wdate" readonly name="endtime"
			id="endtime"
			onfocus="WdatePicker({dateFmt:'H:mm',minDate:'10',maxDate:'23:30'})"
			style="width: 120px;"> 会员姓名： <input type="text"
			class="span2 input-text" id="name1" style="width: 120px;">
	...
	<div class="pd-20">
		<div class="mt-20">
			<p>
				<input type="button" id="auditing" value="批量审核"
					class="btn btn-danger radius auditing">
			</p>
			<table id="onduty"
