...
<body>
	<div class="pd-20">
		<div class="text-c">
			日期范围： <input type="text" name="front"
			...
			<input type="text" name="title" id="" placeholder=" 公告主题"
				style="width: 250px" class="input-text">
			<button name="" id="query" class="btn btn-success" type="submit">
				<i class="Hui-iconfont">&#xe665;</i> 查询公告
			</button>
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <a href="javascript:;" onclick="deleteall()"
				class="btn btn-danger radius" id="deleteAll"><i
					class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
				<button name="" id="add" class="btn btn-primary radius"
					type="submit">
					<i class="Hui-iconfont">&#xe600;</i> 添加公告
				</button>
			</span> <span class="r">共有数据：<strong id="num"></strong> 条
			</span>
		</div>
		<div class="mt-20">
			<table id="notice"
				class="table table-border table-bg table-bordered radius"></table>
		</div>
	</div>
