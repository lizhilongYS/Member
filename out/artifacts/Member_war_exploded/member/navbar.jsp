	...
	<div
		...
		<nav class="uk-navbar">
			<ul class="uk-navbar-nav">
				<li><a href="javascript:;" class="hidden-md hidden-lg"
					data-uk-offcanvas="{target:'#mobileSidebar'}"><i
						class="uk-icon-bars uk-icon-medium"></i></a></li>
					...
					<li class="uk-parent" data-uk-dropdown><a href="">${myuser.member.name}</a>
						<div class="uk-dropdown uk-dropdown-navbar" style="width: 100px">
							<ul class="uk-nav uk-nav-navbar">
								<li><a href="javascript:;" class="uk-text-large" id="exit"><i
										class="uk-icon-sign-out"></i><i>退出</i></a></li>
							</ul>
						</div></li>
				</ul>
			</div>
			...
			<div id="pcSidebar" class="hidden-sm hidden-xs uk-width-2-10">
				<div class="uk-panel uk-panel-box" data-uk-sticky="{top:35}">
					<ul class="uk-nav uk-nav-side uk-nav-parent-icon" data-uk-nav>
						<li><a href="javascript:;" title="主页"><i
								class="uk-icon-home"></i>&nbsp;主页</a></li>
						<li class="uk-parent"><a href="#"><i
								class="uk-icon-money"></i>&nbsp;费用信息</a>
							<ul class="uk-nav-sub">
						...
						<li class="uk-parent"><a href="#"><i
								class="uk-icon-file-text "></i>&nbsp;会员周报</a>
							<ul class="uk-nav-sub">
						...
						<li><a href="${pageContext.request.contextPath}/index.jsp"><i
								class="uk-icon-reply"></i>&nbsp;返回首页</a></li>
					</ul>
				</div>
			</div>
			<!-- 内容 -->
			<div class="uk-width-8-10" id="content"></div>
		</div>
	</div>
	<!-- 手机侧边栏 -->
