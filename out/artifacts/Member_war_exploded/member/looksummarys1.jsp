...
$(function(){
	...
	*/
	...
	function getData(checkType,ownerType,weekType,title,page2){
		...
		$.post("${pageContext.request.contextPath}/summary/getSummarysByNameWithPage.action",{checkType:checkType,ownerType:ownerType,weekType:weekType,title:title,page2:page2},function(data){
			//alert(data);
