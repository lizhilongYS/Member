...
<body>
	...
	<div id="page-footer" style="padding-left: 200px">
		<a
			href="${pageContext.request.contextPath}/visit/history.jsp?pageno=1">首
			页</a> <a
			href="${pageContext.request.contextPath}/visit/history.jsp?pageno=${param.pageno-1}">上一页</a>
		<a
			href="${pageContext.request.contextPath}/visit/history.jsp?pageno=${param.pageno+1}">下一页</a>
		<a id="pagecount"
			href="${pageContext.request.contextPath}/visit/history.jsp?pageno=${pagecount}">尾页</a>
		<c:choose>
			<c:when test="${param.pageno==null}">
		当前第1页<span id="pageCount"></span>
			</c:when>
			<c:when test="${param.pageno!=null}">
				<strong>当前第${param.pageno+1}页</strong>
