	...
	<div align="center" class="container">
		...
		<div class="containerInput">
			...
			<form method="post" name="f1"
				action="${pageContext.request.contextPath}/user/changeInitPassword.action">
				<c:choose>
				...
				<div class="everyInput">
					<span>输入旧密码:</span> <input type="text" class="input-xlarge"
						name="old">
				</div>
				<div class="everyInput">
					<span>输入新密码:</span> <input type="text" class="input-xlarge"
						name="pwd">
				</div>
				<div class="everyInput">
					<span>重复新密码:</span> <input type="text" class="input-xlarge"
						name="pwd1">
				</div>
				<div class="everyInput">
