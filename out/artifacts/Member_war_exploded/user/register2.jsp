...
<script
	src="${pageContext.request.contextPath}/bootstrap/bootstrapvalidator/bootstrapValidator.js"></script>

<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath}/bootstrap/bootstrapvalidator/bootstrapValidator.css">
<script type="text/javascript">
		...
		<div class="row">
			<div class="col-lg-8 col-lg-offset-2">
				...
				<form id="defaultForm" method="post" class="form-horizontal"
					action="${pageContext.request.contextPath}/member/addUserTwo.action">
					...
					<div class="form-group">
						<div class="col-lg-9 col-lg-offset-3">
							<button type="submit" class="btn btn-primary" name="signup"
								value="Sign up">注册</button>
							<button type="button" class="btn btn-info" id="resetBtn">重置</button>
							<a href="${pageContext.request.contextPath}/index.jsp"
								class="btn btn-primary">首页</a> <a
