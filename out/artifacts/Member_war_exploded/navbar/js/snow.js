var RENDERER = {
	...
	render : function(){
		...
		gradient.addColorStop(0, backgroundColor.replace('%l', 80));
		gradient.addColorStop(0.4, backgroundColor.replace('%l', 80));
		gradient.addColorStop(1, backgroundColor.replace('%l',80));
