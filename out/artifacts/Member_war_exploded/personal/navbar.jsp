...
<body>
	<div class="grnavbar">
		<div class="grmenu">
			<ul id="grmenu">
				<li class="li"><a class="nav_cell"><i></i><i></i>个人信息</a>&nbsp&nbsp丨&nbsp&nbsp
				...
				<li class="li"><a class="nav_cell"><i></i><i></i>费用信息</a>&nbsp&nbsp丨&nbsp&nbsp
					<div class="second" style="z-index: 2;">
						<ul>
							<li><a href="javascript:;" title="缴费信息">缴费信息</a></li>
						</ul>
					</div></li>
				<li class="li"><a class="nav_cell" href="javascript:;"
					title="我的周报"><i></i><i></i>我的周报</a>&nbsp&nbsp丨&nbsp&nbsp</li>
				<li class="li"><a class="nav_cell"><i></i><i></i>我的值班</a>
					<div class="second" style="z-index: 2;">
						<ul>
	...
	<c:if test="${myuser.member.flag}">
		<div class="content">
			<div class="grwrap"
				style="padding-left: 50px; margin-top: 50px; margin-bottom: 50px; z-index: 1;"></div>
		</div>
	</c:if>
	<c:if test="${!myuser.member.flag}">
		<div id="tips">
			...
			<div>
				...
				<br />
				<h3>
					亲，为了更好的学习，能够了解更多的信息资讯：<br /> 请点击这里：<a class="hoverfont"
						href="${pageContext.request.contextPath}/user/register.jsp">完善注册信息</a>
				</h3>
				<h5>(只有信息填写完整，才能通过审核哦！！！)</h5>
				<br />
				<p></p>
				<div>
					<hr>
