...
<link
	href="${pageContext.request.contextPath}/tableTemplet/css/H-ui1.css"
...
<body>
	...
	<div class="text-c" style="overflow: auto; width: 100%;">
		<form id="">
			...
			</span>&nbsp; &nbsp; 周报所属： <input type="radio" id="weekType-1"
				name="weekType" value="all"> <label for="weekType-1">全部</label>&nbsp;
			<input type="radio" id="weekType-2" name="weekType" value="previous">
			<label for="weekType-2">向前一周</label>&nbsp; <input type="radio"
				id="weekType-3" name="weekType" value="current"> <label
