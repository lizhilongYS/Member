...
<body>
	<br />
	<div id="nav">
		<a href="javascript:;" id="lookSum">会员周报</a> <a
			href="${pageContext.request.contextPath}/admin/check.jsp">用户审核</a> <a
			href="${pageContext.request.contextPath}/admin/checkimage.jsp">图片审核</a>
		<a href="${pageContext.request.contextPath}/admin/fee.jsp">费用管理</a> <a
			href="${pageContext.request.contextPath}/admin/amount.jsp">费用统计</a>
		<%-- <a href="${pageContext.request.contextPath}/admin/initpwd.jsp">密码管理</a> --%>
		<a
			href="${pageContext.request.contextPath}/memberpay/Direction.action">利息市场</a>
