...
<body>
	...
	<div class="btn-group" style="float: left" id="title">
		<span class="l"> <span
			class="btn btn-primary radius active butname">全部信息</span> <span
			class="btn btn-primary radius butname">正在体验</span> <span
			class="btn btn-primary radius butname">已经加入</span> <span
			class="btn btn-primary radius butname">已经退出</span> <span
			class="btn btn-primary radius butname">预科计划</span> <a
			class="btn btn-primary radius" href="javascript:;" id="add"><i
				class="Hui-iconfont">&#xe600;</i> 添加体验者</a>
		</span>
