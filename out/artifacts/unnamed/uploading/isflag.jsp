...
<body>
	<table class="table table-bordered">
		<tr>
			<td><input type="button" value="通过审核" id="btn" name="pictureid">
				<input type="button" value="删除图片" id="delete"></td>
			<td>
				<div id="imgdiv">
					图片预览<br /> <img
						src="${pageContext.request.contextPath}/picture/userImage.action?id=${param.id}"
						alt="用户图片" width="160" height="200" id="pic">
				</div>
			</td>
		</tr>
	</table>
