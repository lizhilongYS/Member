...
<body>
	<div class="pd-20">
		...
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"><a href="javascript:;" onclick="datadel()"
				...
				onclick="article_add('添加资讯','article-add.html')" href="javascript:;"><i
					class="Hui-iconfont">&#xe600;</i> 添加资讯</a></span> <span class="r">共有数据：<strong>54</strong>
				条
			</span>
		</div>
		<div class="mt-20">
		...
		<div class="page-nav">
			<a><button type="button">上一页</button></a><a><button type="button">1</button></a><a><button
					id="btn-currentpage" type="button">2</button></a><a><button
					type="button">3</button></a><a><button type="button">下一页</button></a>
		</div>
	</div>
