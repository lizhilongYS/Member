...
<body>
	...
	<form class="main form-horizontal" method="post"
		action="${pageContext.request.contextPath}/member/add.action">
		<input type="hidden" name="id" value="${myuser.member.id}"> <input
			type="hidden" id="uid" value="${myuser.id}">
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="member.name" type="text" placeholder="必填项"
					class="input-xlarge" value="${myuser.member.name}" required>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">所在/毕业学校</label>
			<div class="controls">
				<input name="school" type="text" placeholder="必填项"
					class="input-xlarge" value="${myuser.member.school}" required>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">工作单位</label>
			<div class="controls">
				<input name="company" type="text" placeholder="非必填项"
					class="input-xlarge" value="${myuser.member.company}">
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">移动电话</label>
			<div class="controls">
				<input name="mobile" type="text" placeholder="必填项"
					class="input-xlarge" value="${myuser.member.mobile}" required>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<label class="radio"> <input type="radio" value="false"
					name="student" checked="checked">已毕业
				</label> <label class="radio"> <input type="radio" value="true"
					name="student">未毕业
				</label>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				<input name="graduateDate" type="text" placeholder="必填项"
					class="input-xlarge"
					value="<fmt:formatDate value='${myuser.member.graduateDate}' type='date' pattern='yyyy-MM-dd'/>"
					required>
			</div>
		</div>
		<c:if test="${!myuser.member.flag}">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input name="idNo" type="text" placeholder="必填项，实名"
						class="input-xlarge" value="${myuser.userInfo.idNo}" required>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">常用QQ号码</label>
				<div class="controls">
					<input name="qqNo" type="text" placeholder="必填项"
						class="input-xlarge" value="${myuser.userInfo.qqNo}" required>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">支付宝账号</label>
				<div class="controls">
					<input name="payAccount" type="text" placeholder="必填项"
						class="input-xlarge" value="${myuser.userInfo.payAccount}"
						required>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input name="contactName" type="text" placeholder="必填项"
						class="input-xlarge" value="${myuser.userInfo.contactName}"
						required>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input name="relation" type="text" placeholder="必填项"
						class="input-xlarge" value="${myuser.userInfo.relation}" required>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">家庭联系人手机</label>
				<div class="controls">
					<input name="contactMobile" type="text" placeholder="必填项"
						class="input-xlarge" value="${myuser.userInfo.contactMobile}"
						required>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<input name="address" type="text" placeholder="必填项"
						class="input-xlarge" value="${myuser.userInfo.address}" required>
				</div>
			</div>
		</c:if>
