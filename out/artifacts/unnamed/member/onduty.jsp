	...
	<div style="padding-left: 300px">
		<table class="title" style="padding-left: 300px">
			<tr>
				...
				<td>值班信息:</td>
				<td><select style="margin-top: 10px;" name="type">
						<option value="0">我的值班申请</option>
						<option value="1">会员值班申请</option>
				</select></td>
				<td><input class="btn" type="button" id="query" value="查询" /></td>
		...
		<table class="title" style="padding-left: 165px">
			<tr>
				...
				<td><input type="text" class="span2" name="startdate"
					...
					onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-{%d+2}' })"></td>
