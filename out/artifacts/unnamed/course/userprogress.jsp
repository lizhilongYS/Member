...
$(function() {
	...
	function lookprogressclick(){
		$(".lookprogress").click(function(){
			...
			layer.open({
			    ...
			    shift:1,
			    shade: 0.5, //开启遮罩关闭
			    content: '${pageContext.request.contextPath}/course/lookprogress.jsp?id='+id+'&identityType='+identityType,
			    end: function() {    	
			    getData(page2);
			    }
			});				
	...
	function drawTable(data) {	
		...
		for(i = 0;i < data.length;i++) {
			...
			line=line + "<td>" + "<a class='lookprogress' lang='"+data[i].id+","+data[i].identityType+"'>查看</a>" + "</td>";
			line=line + "</tr>";
			line=line + "</tbody>"
		}
		$("#courses").html(line);
