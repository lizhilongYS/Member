...
<script type="text/javascript">
    	$(function(){
			$("#frame").load("${pageContext.request.contextPath}/notice/lastnotice.jsp");
...
<body style="background-color: #EBF2F9;">
	<span style="margin-left: 11px;"> <a href="javascript:;"
		style="text-decoration: none; color: #000000; font-weight: 600;"
		id="lastnotice">最新公告</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
		href="javascript:;"
		style="text-decoration: none; color: #000000; font-weight: 600;"
		id="history">历史公告</a>
	</span>
