...
$(function(){
	...
	$("[type='button']").click(function(){
		...
		$.post("${pageContext.request.contextPath}/experience/setAssistant.action",{aid:aid,id:id},function(){
			layer.msg('设置成功', {
			    icon: 1,
			    time: 1000
			}, function(){
...
<body>
	...
	<div class="text-c">
		<h1>小助手设置</h1>
		为【${param.name }】设置小助手..<br> <select id="assistants">
			<option value="0">请选择小助手</option>
		</select> <input type="button" value="确认"><br> <span id="infoshow"></span>
	</div>
</body>
</html>