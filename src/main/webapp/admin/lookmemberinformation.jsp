...
<body>
	...
	<div id="menu1" style="display:none;">
		<a id="baseinfo">基本信息</a> <a id="summaryinfo">周报信息</a> <a id="feeinfo">缴费信息</a>
		<a id="protocol">培训协议</a> <input type="hidden" id="member"
			value="${myuser.member}">
	</div>
	<div class="showinfo"
		style="margin-left: 0; padding-left: 10px; margin-top: 30px;"></div>
</body>
</html>