...
<body>
	<div class="container">
		<div class="bs-example" data-example-id="large-well">
			<div class="page-header" id="text"></div>
			<div
				style="background-color: #EEEEEE; width: 703px; height: 50px; border-radius: 6px; position: relative;">
				<span
					style="font-weight: 600; font-size: 22px; color: #666666; position: relative; left: 0px; top: 7px;">修改工作日志时间:&nbsp;&nbsp;&nbsp;<input
					class="form-control" id="wdate" type="text" style="height: 20px;"
					readonly></span>
			</div>
			<div>
	...
	<input type="button" style="margin-left: 640px;"
		class="btn btn-default radius" id="modify" value="保存日志" />
</body>
</html>