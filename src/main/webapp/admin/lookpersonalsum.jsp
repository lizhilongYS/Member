...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/layer/layer-v2.0/layer/extend/layer.ext.js"></script>
<style type="text/css">
</style>
<script type="text/javascript">
$(function(){
	...
	function drawTable(data){
		...
		for(i=0;i<data.length;i++){
			...
			if(data[i].sid==0){
				...
				operation="<a href='javascript:void(0)' class='tit' lang='"+data[i].sid+"'>&nbsp;|</a>";	
...
<body>
	...
	<div class="text-c" style="padding-left: 0; padding-right: 60px;">
		<form id="">
			审核状态： <span class="select-box inline"> <select
				name="checkType" class="select">
					<option value="all">不限</option>
					<option value="checked">已审核</option>
					<option value="nonchecked">未审核</option>
			</select>
			</span> <input type="radio" id="weekType-1" name="weekType" value="all">
			<span class="select-box inline"> <label for="weekType-1">全部</label>&nbsp;
			</span> <input type="radio" id="weekType-2" name="weekType" value="previous">
			<span class="select-box inline"> <label for="weekType-2">向前一周</label>&nbsp;
			</span> <input type="radio" id="weekType-3" name="weekType" value="current"
				checked> <span class="select-box inline"> <label
				for="weekType-3">本周</label>&nbsp;
			</span> <input type="radio" id="weekType-4" name="weekType" value="next">
			<span class="select-box inline"> <label for="weekType-4">向后一周</label>&nbsp;
			</span> <span class="select-box inline"> <input type="hidden"
				name="title" value="">
	...
	<br>
	<div class='page-nav' style="padding-right: 120px">
		<input type="hidden" id="mid" value="${myuser.member.uid}">
	</div>
