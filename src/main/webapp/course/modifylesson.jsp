...
$(function(){
	...
	$("#modify").click(function(){		
		...
		$.ajaxSetup({async:false});
		$.post("${pageContext.request.contextPath}/course/modifyLesson.action",{id:id,chid:$("[name='chid']").val(),title:$("[name='title']").val()},function(data){
			...
			<div class="panel-body">
				<form name="add">
					<table class="table table-hover">
						<tr>
							<th>所属章节</th>
							<td><select name="chid" class="form-control"
