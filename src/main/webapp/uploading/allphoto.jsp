...
<body>
	...
	<div id="footer">
		<a
			href="${pageContext.request.contextPath}/uploading/allphoto.jsp?pageno=1">首
			页</a>&nbsp;|&nbsp; <a
			href="${pageContext.request.contextPath}/uploading/allphoto.jsp?pageno=${param.pageno-1}">上一页</a>&nbsp;|&nbsp;
		<a
			href="${pageContext.request.contextPath}/uploading/allphoto.jsp?pageno=${param.pageno+1}">下一页</a>&nbsp;|&nbsp;
		<a id="pagecount"
			href="${pageContext.request.contextPath}/uploading/allphoto.jsp?pageno=${pagecount}">尾页</a>&nbsp;|&nbsp;
		<c:choose>
			<c:when test="${param.pageno==null}">
		当前第1页
	</c:when>
			<c:when test="${param.pageno!=null}">
				<strong>当前第${param.pageno+1}页/总共<span id="pageCount">${pagecount}</span>页
				</strong>
			</c:when>
		</c:choose>
		&nbsp;|&nbsp; <a
			href="${pageContext.request.contextPath}/member/infoshow.jsp">用户信息</a>&nbsp;|&nbsp;
	</div>
</body>
</html>