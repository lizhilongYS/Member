...
<link href="${pageContext.request.contextPath}/css/style.css"
	rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/chocolat.css"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/jslib/move-top.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/jslib/easing.js"></script>
<script type="text/javascript">
...
<body>
		...
		<div class="container">
			<div class="logo">
				<c:if test="${sessionScope.TURE!=null}">
					<h1>
						<a href="${pageContext.request.contextPath}/clue/myjumps.jsp">Join</a>
					</h1>
				</c:if>
				<c:if test="${sessionScope.TURE==null}">
					<h1>
						<a href="${pageContext.request.contextPath}/user/login.jsp">Join</a>
					</h1>
				</c:if>
			</div>
			<div class="top-menu">
	...
	<div class="footer">
		<div class="container">
			<p>
				Copyright &copy; 2004 - 2016.IT精英会员俱乐部.All Rights Reserved.<a
					target="_blank" href="http://www.xinqushi.net"></a>
			</p>
			<div class="social">
