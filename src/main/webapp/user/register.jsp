					...
					<ul id="myTab" class="nav nav-tabs">
						...
						<li class="dropdown"><a href="#" id="myTabDrop1"
							...
							<ul class="dropdown-menu" role="menu"
								...
								<li><a
									href="${pageContext.request.contextPath}/user/login.jsp">登录</a></li>
							</ul></li>
					</ul>
				</h1>
			</div>
								...
								<table class="table table-hover">
									...
									<tr>
										...
										<td><input name="pwd1" type="password" AUTOCOMPLETE=OFF
											style="width: 200px" class="form-control" placeholder="必填"
											value="${myuser.pwd}" /></td>
									</tr>
									<tr>
								</table>
							...
							<c:if test="${sessionScope.myuser!=null}">
								<table class="table table-hover">
									...
									<tr>
										...
										<td>请填写下一页个人信息：
											<button type="button" class="btn btn-default" id="next1">
						...
						<div class="panel-body">
							<c:if test="${sessionScope.myuser.member.mobile==null}">
								<table class="table table-hover">
									...
									<tr>
										<th>真实姓名</th>
										<td><input id="member.name" name="member.name"
											type="text" placeholder="必填项" style="width: 200px"
									...
									<tr>
										...
										<td><input type="radio" value="false" name="student"
											checked="checked">已毕业 <input type="radio"
											value="true" name="student" onClick="stu">未毕业</td>
									</tr>
									<tr>
										<th>毕业时间</th>
										<td><input type="date" id="graduateDate"
											name="graduateDate" value="2000-07-15" onchange="chkDate()"
											placeholder="必填项" class="form-control" style="width: 200px" />
										</td>
									</tr>
									<tr>
										<td colspan="2">
									...
									<tr>
										...
										<td>
											<div style="margin-left: 160px">
												<a style="color: #F00" href="javascript:;"
													onclick="onJump()">跳过</a>
											</div>
										</td>
									</tr>
							...
							<c:if test="${sessionScope.myuser.member.mobile!=null}">
								<table class="table table-hover">
									...
									<tr>
										<td style="color: #F00;">此页信息已注册</td>
										<td>请填写下一页个人信息：
											<button type="button" class="btn btn-default" id="next2">
												<a href="#" data-toggle="tab">下一页</a>
											</button>
										</td>
									</tr>
						...
						<div class="panel-body">
									...
									<div class="jumbotron" align="left"
										...
										<p align="center">
											<a class="btn btn-primary btn-lg" role="button"
												href="${pageContext.request.contextPath}/member/navbar1.jsp">
							...
							<c:if test="${sessionScope.myuser.userInfo.idNo==null}">
								<table class="table table-hover">
									...
									<tr>
										<th>家庭联系人</th>
										<td><input id="contactNamw" name="contactName"
									...
									<tr>
										<td colspan="2"><input type="hidden" name="pensonalInfo"
											value="0" />
											<div id="msg3"
												style="color: red; font-weight: bold; font-size: 15px;"
												align="center"></div></td>
