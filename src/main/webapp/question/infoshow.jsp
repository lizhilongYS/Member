...
.operate ul li a {
	background: url(../images/bg1.png) no-repeat 100px 18px;
	padding-left: 30px;
...
.operate ul li h4 {
	cursor: pointer;
	background: url(../images/bg3.png) no-repeat 16% 18px;
	padding-left: 30px;
	text-decoration: none;
	font-size: 16px;
	color: #555;
...
<body>
	...
	<div style="width: 1480px; margin-left: 100px; folat: left;">
		...
		<h2 align="center">
			问题分享页面<small id="msg"></small>
		</h2>
		<table class="table table-hover"
			style="padding-top: 100px; padding-bottom: 300px;">
			...
			<c:forEach var="it" items="${list}" varStatus="item">
				<tr style="width: 50%; height: 150px;">
					...
					<span style="color: red">问题：</span></th>
					<td>${it.question}</td>
				</tr>
				<tr style="width: 50%; height: 150px;">
					<th align="center"><br /> <br />
					<span style="color: #4a86ea">答案：</span></th>
					<td>${it.solution}</td>
				</tr>
			</c:forEach>
		</table>
		<button type="button" class="btn btn-info" id="share">-- 问题分享
			--</button>
