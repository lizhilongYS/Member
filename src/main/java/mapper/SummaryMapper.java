...
import entity.SummaryRecommend;
...
public interface SummaryMapper {
	...
	public List<LookSummary> getExperienceSummarys(
            String name);
	public int referralSumarry(Summary summary);
	
	public List<SummaryRecommend> getRecommendvalSummarys(Map<String, Object> paramMap);
	
	public List<String>getPreSummaryIdByUserId(Map<String, Object> paramMap);
	
	public List<String>getNextSummaryIdByUserId(Map<String, Object> paramMap);
	
	public List<String>getCurrentSummaryIdByUserId(Map<String, Object> paramMap);
	
	public List<String>getFirstSummaryIdByUserId(Map<String, Object> paramMap);	
}
