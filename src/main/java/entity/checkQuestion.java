...
public class checkQuestion implements Serializable {
	...
	public String toString() {
		return "checkQuestion [Id=" + Id + ", cId=" + cId + ", ctitle=" + ctitle + ", question=" + question + ", qpId="
				+ qpId + ", qperson=" + qperson + ", solution=" + solution + ", time=" + time + ", spId=" + spId
				+ ", checktime=" + checktime + ", state=" + state + ", sperson=" + sperson + "]";
	}
