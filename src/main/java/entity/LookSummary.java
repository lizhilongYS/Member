...
public class LookSummary {
	...
	public void setRecommendval(int recommendval) {
		this.recommendval = recommendval;
	}
	@Override
	public String toString() {
		return "LookSummary [sid=" + sid + ", title=" + title + ", content=" + content + ", ischeckval=" + ischeckval
				+ ", recommendval=" + recommendval + ", time=" + time + ", id=" + id + ", num=" + num + ", name=" + name
				+ ", aid=" + aid + ", summaryflag=" + summaryflag + ", identityType=" + identityType + ", arealname="
				+ arealname + "]";
	}
