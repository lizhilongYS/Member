...
$(function(){	
	...
	$("#add").click(function(){	
		...
		$.post("${pageContext.request.contextPath}/course/add.action",{title:$("[name='title']").val(),optional_flag:optional_flag},function(data){
			...
			<div class="panel-body">
				<form name="add">
					<table class="table table-hover">
						...
						<tr>
							<th>是否选修</th>
							<td><input type="radio" value="true" name="optional_flag">是
								<input type="radio" value="false" name="optional_flag"
								style="margin-left: 20px" checked="checked">否</td>
						</tr>
						<tr>
							<td colspan="2">
								<div id="msg"
