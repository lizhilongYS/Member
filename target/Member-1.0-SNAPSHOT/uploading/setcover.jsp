...
<script type="text/javascript"
	src="../uploadPreview/uploadPreview.min.js"></script>
		...
		<div id="imgdiv">
			...
			<c:if test="${conut==0}">
				<img src="${pageContext.request.contextPath}/images/4.jpg"
					alt="用户上传图片" width="200" height="200" id="pic">
			</c:if>
			<c:if test="${conut!=0}">
				<img
					src="${pageContext.request.contextPath}/picture/getCover.action?id=${myuser.id}"
					class="img" width="200" height="200" alt="用户上传图片" id="imageshow">
			</c:if>
		</div>
		<div id="f">
			<form enctype="multipart/form-data" action="" method="post" id="form">
				<input type="file" id="studentPhoto" name="studentPhoto" /> <input
					type="hidden" value="1" name="cover">
			</form>
