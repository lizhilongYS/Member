...
<body>
	<div id="i">
		<div id="imgdiv">
			图片预览<br /> <img
				src="${pageContext.request.contextPath}/picture/imageshow.action?id=${param.id}"
				alt="用户上传图片" width="160" height="200" id="pic">
		</div>
		<div id=f>
			<form enctype="multipart/form-data" action="" method="post" id="form">
				照片名称： <input type="text" id="title" name="title"
					class="input-xlarge" placeholder="请输入修改内容" value="" /> <input
