...
<head>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/bootstrap/css/bootstrap3.min.css">
...
<body>
	<form:form
		action="${pageContext.request.contextPath}/ondutylog/add.action"
		commandName="ondutylog" modelAttribute="ondutylog" id="ondutylog"
		...
		<div class="container">
			...
			<div class="form-group form-group-md">
				...
				<div class="col-md-3 col-md-offset-2">
					<input type="text" name="beHelpedName" class="form-control"
						placeholder="被帮助者的姓名">
				</div>
			</div>
			<br>
			<div class="form-group form-group-md">
				...
				<div class="col-md-3 col-md-offset-2">
					<input type="text" name="beHelpedQQ" class="form-control"
						placeholder="被帮助者的QQ">
				</div>
			</div>
			<br>
			<div class="form-group form-group-md">
				...
				<div class="col-md-6 col-md-offset-2">
					<input type="text" name="beHelpedInfo" class="form-control"
						placeholder="被帮助者的个人情况">
				</div>
			</div>
			<br>
			<div class="form-group form-group-md">
				...
				<div class="col-md-7 col-md-offset-2">
					<textarea class="form-control" rows="3" name="qustionDescription"
			...
			<div class="form-group form-group-md">
				<label class="sr-only">解决情况</label>
				<div class="col-md-7 col-md-offset-2">
					<textarea class="form-control" rows="3" name="solutionReport"
						placeholder="解决情况"></textarea>
				</div>
			</div>
			<br>
			<div class="form-group form-group-md">
			...
			<div>
				<input type="hidden" value=${APPLY } id="apply">
			</div>
		</div>
	</form:form>
</body>
