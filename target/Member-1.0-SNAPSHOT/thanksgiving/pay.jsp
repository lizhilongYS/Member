...
<body>
	<div class="wrap" style="padding-left: 50px; margin-top: 30px">
		<nav> <a
			href="${pageContext.request.contextPath}/thanksgiving/restinfo.jsp">利息明细</a>&nbsp;|&nbsp;
		...
		<br /> 可用利息为：<font color="red"><c:out value="${rest}"></c:out></font>元<br />
		<form class="main form-horizontal">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="mobile" type="text" placeholder="*对方手机号码"
			...
			<div class="control-group">
				...
				<div class="controls">
					<input id="money" type="text" placeholder="*输入整数金额"
						class="input-xlarge" required>
				</div>
			</div>
			<div class="control-group">
