...
$(function(){ 
	...
	*/
	...
	$.post("${pageContext.request.contextPath}/summary/checkRemind.action",function(data){
		if(data>0 && $("body").width()>767){//小屏幕不显示提示		
	...
	$("[title='问答分享']").click(function(){
		hidePhoneMenu();
		$(".wrap").load("${pageContext.request.contextPath}/question/sharequestion.jsp");
	});	
	...
	$("[title='所有周报']").click(function(){
		hidePhoneMenu();
		$(".wrap").load("${pageContext.request.contextPath}/member/infomanagement.jsp");
	});
	...
	$("[title='学习资源']").click(function(){
		hidePhoneMenu();
		$(".wrap").load("${pageContext.request.contextPath}/member/resources.jsp");
	});
...
function writeclick(){
		$("[title='编写周报']").click(function(){
			$.ajaxSetup({async:false});
			$.post("${pageContext.request.contextPath}/user/logger.action",{content:"member navbar1.jsp:write click"});
			hidePhoneMenu();
...
function modifyclick(){
	$("[title='修改周报']").click(function(){
		$.post("${pageContext.request.contextPath}/user/logger.action",{content:"member navbar1.jsp:modify click"});
		hidePhoneMenu();
...
<body>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-sm-10 col-xs-10">
					<div class="callout text-right" style="float: left">
						<span
	...
	<div class="left-menu">
		<ul id="menu">
			<li class="menu-list"><a style="cursor: pointer"
				href="javascript:;" title="主页"><i></i><i class="Hui-iconfont">&#xe625;</i>主页</a>
			</li>
			<c:if test="${myuser.member.flag}">
				<li class="menu-list"><a style="cursor: pointer"><i></i><i
						class="Hui-iconfont">&#xe63a;</i>费用信息</a>
					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;" title="会员缴费"><i></i><i></i><i></i>会员缴费</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="利息市场"><i></i><i></i><i></i>利息市场</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="缴费信息"><i></i><i></i><i></i>缴费信息</a></li>
					</ul></li>
				<li class="menu-list"><a style="cursor: pointer"><i></i><i
						class="Hui-iconfont">&#xe647;</i><span id="summary">会员周报</span></a>

					<ul class="child-menu">
						<li id="taggleWriteAndModify"></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="查看周报"><i></i><i></i><i></i>本周周报</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
				...
				<li class="menu-list"><a style="cursor: pointer"
					href="javascript:;"><i></i><i class="Hui-iconfont">&#xe623;</i>值班信息</a>
					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;"
							title="值班申请"><i></i><i></i><i></i>值班申请</a></li>
						<!-- <li><a style="cursor:pointer" href="javascript:;" title="值班日志"><i></i><i></i><i></i>值班日志</a></li> -->
						<li><a style="cursor: pointer" href="javascript:;"
							title="值班历史"><i></i><i></i><i></i>值班历史</a></li>
					</ul></li>
				<li class="menu-list"><a style="cursor: pointer"><i></i><i
						class="Hui-iconfont">&#xe62b;</i>会员信息</a>

					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;"
							title="会员统计"><i></i><i></i><i></i>会员统计</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="学校信息"><i></i><i></i><i></i>学校信息</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="查询人员"><i></i><i></i><i></i>查询人员</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="会员照片"><i></i><i></i><i></i>会员照片</a></li>
					</ul></li>
				<li class="menu-list"><a style="cursor: pointer"><i></i><i
						class="Hui-iconfont">&#xe61c;</i>课程进度</a>
					...
					<ul class="child-menu">
						...
						<li><a style="cursor: pointer" href="javascript:;"
							title="问答分享"><i></i><i></i><i></i>问题分享</a></li>
					</ul></li>
				<li class="menu-list"><a style="cursor: pointer"
					class="menuItem" title="学习资源"> <i></i><i class="Hui-iconfont">&#xe623;</i>学习资源
				</a></li>
				<!-- <li class="menu-list" >
               <a style="cursor:pointer" ><i></i><i class="Hui-iconfont">&#xe61e;</i>社交</a>
				...
				<li class="menu-list"><a style="cursor: pointer"><i></i><i
						class="Hui-iconfont">&#xe62c;</i>个人中心</a>
					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;"
							title="会员信息"><i></i><i></i><i></i>会员信息</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="信用信息"><i></i><i></i><i></i>信用信息</a></li>
						<c:if test="${myuser.name!=888}">
							<li><a style="cursor: pointer" href="javascript:;"
								title="修改密码"><i></i><i></i><i></i>修改密码</a></li>
						</c:if>
						<li><a style="cursor: pointer" href="javascript:;"
							title="会员协议"><i></i><i></i><i></i>会员协议</a></li>
					</ul></li>
			</c:if>


			<c:if test="${!myuser.member.flag}">
				<li class="menu-list"><a style="cursor: pointer"><i></i><i></i>费用信息</a>

					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;" title="会员缴费"
							onClick="noRoot()"><i></i><i></i><i></i>会员缴费</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="利息市场" onClick="noRoot()"><i></i><i></i><i></i>利息市场</a></li>
					</ul></li>
				<li class="menu-list"><a style="cursor: pointer"><i></i><i></i>会员周报</a>

					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;"
							title="查看周报" onClick="noRoot()"><i></i><i></i><i></i>查看周报</a></li>
					</ul></li>
				<li class="menu-list"><a style="cursor: pointer"><i></i><i></i>值班信息</a>

					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;"
							title="值班申请" onClick="noRoot()"><i></i><i></i><i></i>值班申请</a></li>
				...
				<li class="menu-list"><a style="cursor: pointer"><i></i><i></i>会员信息</a>

					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;"
							title="会员统计" onClick="noRoot()"><i></i><i></i><i></i>会员统计</a></li>
					</ul></li>
				<li class="menu-list"><a style="cursor: pointer"><i></i><i
						class="Hui-iconfont">&#xe61c;</i>课程进度</a>
					...
					<ul class="child-menu">
						<li><a style="cursor: pointer" href="javascript:;"
							title="进度选择" onClick="noRoot()"><i></i><i></i><i></i>进度选择</a></li>
						<li><a style="cursor: pointer" href="javascript:;"
							title="会员进度" onClick="noRoot()"><i></i><i></i><i></i>会员进度</a></li>
					</ul></li>
				<!-- <li class="menu-list" >
               <a style="cursor:pointer" ><i></i><i class="Hui-iconfont">&#xe61e;</i>社交</a>
                <ul class="child-menu">
				...
				<li class="menu-list"><a style="cursor: pointer"
					href="javascript:;" title="个人中心" onClick="noRoot()"><i></i><i
						class="Hui-iconfont">&#xe62c;</i>个人中心</a></li>
			</c:if>

			<li class="menu-list"><a style="cursor: pointer"
				href="${pageContext.request.contextPath}/index.jsp"><i></i><i
					class="Hui-iconfont">&#xe66b;</i>返回首页</a></li>
		</ul>
	</div>
	...
	<div class="right-content">
		<div class="content">
			<div class="container-fluid">
				<%--<div class="wrap" style="padding-left:20px;margin-top:15px;"></div>      --%>
