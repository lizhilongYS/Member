...
<body>
		...
		<table class="title" style="padding-left: 0px">
			<tr>
				...
				<td><input type="text" name="date" id="date"
					onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true})"></td>
				<td><input class="btn" type="button" id="add" value="我要申请" /></td>
			</tr>
		</table>
	</div>

	<div style="display: none; padding-left: 600px; padding-top: 20px;"
		id="hha">
		<table class="title" style="padding-left: 165px">
			<tr>
				<td>选择值班时间:</td>
				<td><input type="text" class="span2" name="startdate"
					id="startdate" readonly="readonly"
					onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"></td>
				<td><input class="span1" type="text" readonly name="starttime"
					id="starttime"
					onfocus="WdatePicker({dateFmt:'H:mm',minDate:'8:30',maxDate:'21:30',onpicked:function(){endtime.focus()} })"></td>
				<td>~</td>
				<td><input class="span1" type="text" readonly name="endtime"
					id="endtime"
					onfocus="WdatePicker({dateFmt:'H:mm',minDate:'10',maxDate:'23:30'})"></td>
				<td><input class="btn" type="button" id="apply" value="申请" /></td>
			</tr>
		</table>
	...
	<br>
	<div id="navbar" class='page-nav' style="margin-right: 4%;">
